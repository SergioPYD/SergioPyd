...
import la33Pic1 from "../assets/la33pic2.png"
import la33Pic from "../assets/la33pic.png"
import la33Pic2 from "../assets/la33pic1.png"
import la33Visual from "../assets/la33Visual.png"

export default function La33Page() {
      ...
      <div className="flex flex-col my-10 gap-8">
        <p>
          {language === "es"
            ...
            : "Racing game in which, at the helm of Fernando Alonso's car, you will attempt to achieve the goal of winning the 33rd race in our protagonist's history. Relive Alonso's most epic battles as you go up against rivals such as Michael Schumacher, Lewis Hamilton, or the most recent Max Verstappen. The game features different stages of increasing difficulty as you progress, along with various power-ups to aid you during races. Unlock the 'Hardcore' mode once you successfully complete the game to test yourself and see how many races you can win at the highest difficulty level without power-ups."}
        </p>
        ...
        <p>
          {language === "es"
            ? "Este proyecto corresponde al Módulo 1 del Bootcamp de Desarrollo Web de Ironhack. Fue desarrollado utilizando HTML, CSS, JavaScript, Manipulación del DOM, Clases de JavaScript, la clase JS Audio() y la clase JS Image()."
            : "This project was the Module 1 project of Ironhack's Web Developer Bootcamp. It was built using HTML, CSS, JavaScript, DOM Manipulation, JS Classes, JS Audio(), and JS Image()."}
        </p>
        <Image is isZoomed src={la33Visual} />

        <p >
          {language === "es"
            ? "Sin lugar a dudas, este proyecto fue uno de los que más disfruté creando. Fue asombroso descubrir lo que se puede lograr mediante la manipulación del DOM y el uso de funciones en JavaScript. El juego está actualmente optimizado para pantallas con una frecuencia de actualización de 60 hercios, pero tengo planes de adaptarlo en el futuro para que funcione perfectamente en todo tipo de pantallas, incluyendo dispositivos móviles."
            : "Undoubtedly, this project was one of the most enjoyable experiences for me. It's incredible what you can achieve through DOM manipulation and JavaScript functions. The game is currently designed for 60Hz screens, but I hope to adapt it for all screen sizes in the future, and even create a mobile version."}
        ...
        <div className="flex justify-center gap-4">
          <Link
            ...
            href="https://github.com/SergioPYD/Proyecto1-la-33-alonso-game"
            isExternal
            color="primary"
          >
            FULL CODE
          ...
          <Link
            ...
            href="https://sergiopyd.github.io/Proyecto1-la-33-alonso-game/"
            isExternal
            color="secondary"
          >
            SEE IT LIVE
