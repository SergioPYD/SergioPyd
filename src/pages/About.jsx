    ...
    <div className="flex flex-col ">
      <div className="flex flex-wrap justify-center items-center ">
        <div style={{ width: "500px" }}>
          <p className="flex justify-center content-center mb-10 md:pr-12 animate-fade-right animate-once animate-ease-linear">
            {language === "es"
      ...
      <div className="flex flex-wrap justify-center items-center ">
        ...
        />
        <div style={{ width: "500px" }}>
          <p className="flex items-start mt-10 md:pl-12 animate-fade-left animate-once animate-delay-300 animate-ease-linear">
            {language === "es"
              ? "En la actualidad, he dado un giro en mi vida profesional al enfocarme en el desarrollo web. Estoy interesado tanto en la parte de Frontend como en la de Backend, lo que demuestra mi deseo de aprender y crecer en un campo tecnológico en constante evolución. Mi historia refleja una combinación única de habilidades en liderazgo, gestión empresarial y desarrollo web. Este cambio en mi carrera muestra mi adaptabilidad y disposición para enfrentar nuevos desafíos, lo que me coloca en una posición prometedora para mi futuro profesional en el campo de la tecnología y el desarrollo web."
              : "Currently, I have made a significant career shift by focusing on web development, encompassing both Frontend and Backend aspects. This reflects my eagerness to learn and grow in a constantly evolving technological field. My story reflects a unique blend of leadership, business management, and web development skills. This career transition demonstrates my adaptability and willingness to take on new challenges, positioning me promisingly for my professional future in the technology and web development realm."}{" "}
          </p>
        </div>
      </div>
    </div>
